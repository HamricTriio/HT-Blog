(() => {
  // ns-params:@params
  var baseURL = "https://example.org/HT-Blog/";
  var params = { algolia: { appid: "YOUR_KEY", appkey: "YOUR_APP_KEY", enabled: true, searchindex: "YOUR_INDEX" }, blogroll: [{ name: "Apple", url: "https://Apple.com/" }, { name: "Google", url: "https://Google.com/" }], css: [{ url: "css1.css" }, { url: "css2.css" }], defaultcover: "https://example.com/cover.jpg", email: "floyd.li@outlook.com", js: [{ url: "js1.js" }, { url: "js2.js" }], showcopyright: true, showmore: true, showrss: true, socialmedia: [{ name: "Github", url: "https://github.com/floyd-li" }, { name: "Twitter", url: "https://twitter.com/some-one" }] };
